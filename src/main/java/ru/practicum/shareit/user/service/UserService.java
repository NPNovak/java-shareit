...
public class UserService {
    ...
    public UserResponse addUser(UserCreate user, BindingResult bindingResult) throws Exception {
        UserValidation.validation(bindingResult);
        return mapper.toUserResponse(userStorage.addUser(mapper.toUser(user)));
    }

    public UserResponse updateUser(UserUpdate user, Integer userId, BindingResult bindingResult) throws Exception {
        UserValidation.validation(bindingResult);
