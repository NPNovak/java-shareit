...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserResponse> addUser(@Valid @RequestBody UserCreate user, BindingResult bindingResult) throws Exception {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<UserResponse> updateUser(@Valid @RequestBody UserUpdate user, @PathVariable("id") Integer userId, BindingResult bindingResult) throws Exception {
